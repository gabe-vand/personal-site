...
| Send it: button origami-folds into the plane (js/fold.js), flies on a breeze with a loop (js/plane.js), returns as Sent ✓; tags plane-v2-breeze / plane-v3-fold | `site/js/fold.js`, `site/js/plane.js` | done |
